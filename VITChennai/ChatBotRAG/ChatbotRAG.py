...
# Load additional documents from the specified directory
documents = SimpleDirectoryReader(r".\AdditionalDocs").load_data()
...
# create collection
chroma_collection = db.get_or_create_collection("nasa_database")
